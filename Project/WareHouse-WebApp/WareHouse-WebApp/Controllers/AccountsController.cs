...
namespace WareHouse_WebApp.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,Username,Password,Status")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("EmployeeId,Username,Password,Status")] Account account)
        {
        ...
        {
          return (_context.Accounts?.Any(e => e.EmployeeId == id)).GetValueOrDefault();
        }
    }
}
